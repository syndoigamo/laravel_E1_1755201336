...
@include('layouts.alert')
  ...
  <div class="form-group row">
    <label for="kode_prodi" class="col-sm-12">Kode Prodi</label>
      ...
      placeholder="Masukan kode mata kuliah" value="{{ $prodi->kode_prodi }}" readonly>
      @error('kode_prodi')
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
    <input type="text" name="nama_prodi" class="form-control" id="nama_prodi" placeholder="Masukan nama mata kuliah" value="{{ $prodi->nama_prodi }}">
      @error('nama_prodi')
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
    <input type="text" name="kaprodi" class="form-control" id="kaprodi" placeholder="Masukan Nama Kaprodi" value="{{ $prodi->kaprodi }}">
      @error('kaprodi')
